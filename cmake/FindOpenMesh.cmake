...
#   
# copyright: https://github.com/MEPP-team/MEPP
...
IF (OPENMESH_INCLUDE_DIR)
	...
	SET(OPENMESH_LIBRARY_RELEASE
		optimized ${OPENMESH_CORE_LIBRARY_RELEASE}
		optimized ${OPENMESH_TOOLS_LIBRARY_RELEASE})
	...
	SET(OPENMESH_LIBRARY_DEBUG
		debug ${OPENMESH_CORE_LIBRARY_DEBUG}
		debug ${OPENMESH_TOOLS_LIBRARY_DEBUG})
ENDIF (OPENMESH_INCLUDE_DIR)

if(OPENMESH_LIBRARY_RELEASE)
  if(OPENMESH_LIBRARY_DEBUG)
    set(OPENMESH_LIBRARIES_ ${OPENMESH_LIBRARY_RELEASE} ${OPENMESH_LIBRARY_DEBUG})
  else()
